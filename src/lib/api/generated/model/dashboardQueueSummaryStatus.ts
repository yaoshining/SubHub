...
export type DashboardQueueSummaryStatus =
  (typeof DashboardQueueSummaryStatus)[keyof typeof DashboardQueueSummaryStatus];

export const DashboardQueueSummaryStatus = {
  idle: "idle",
} as const;

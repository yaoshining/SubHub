...
export type SubtitleValidatorSearchField =
  (typeof SubtitleValidatorSearchField)[keyof typeof SubtitleValidatorSearchField];

export const SubtitleValidatorSearchField = {
  title: "title",
  query: "query",
  language: "language",
  type: "type",

export const localRealPostgresTestFiles = [
  ...
  "tests/integration/storage/bootstrap-state.test.ts",
  ...
  "tests/integration/storage/seed-repeatability.test.ts",
  "tests/smoke/staging-dev-seed.smoke.test.ts",
] as const;
